            ...
            <div class="col-12 text-center m-0 p-0">
                <div class="position-relative">
                    ...
                    <div class="position-absolute btn-float-mr">
                        <button type="button" class="btn bg-marn-blue text-white rounded-circle btn-lg" style="padding:1rem;" data-bs-toggle="modal" data-bs-target="#exampleModalFullscreen">
