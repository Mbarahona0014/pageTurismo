      ...
      <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
          ...
          <div class="modal-body" style="overflow-y: auto;">
            ...
            <p><b>Al realizar una reserva, el cliente acepta los siguientes términos y condiciones:</b></p>
            <br>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div id='calendario-vanilla' style="width: 100%;"></div>
            <div id='permite-acampar' style="max-height: 60vh; overflow-y: auto;"></div>
